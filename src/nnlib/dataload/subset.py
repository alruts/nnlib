...
from nnlib.dataload.data_structures import PointCloud, SpatialDiscretisationND
...
def grid_sample(
    ...
    >>> import jax.numpy as jnp
    >>> from nnlib.dataload.data_structures import SpatialDiscretisationND, PointCloud
